...
public class Estacionamento {
    ...
    public void entraVeiculo(Veiculo veiculo) {
        if (veiculo instanceof Carro) {
            if (carros.size() < numeroVagasCarros) {
                ...
                System.out.println("Nao ha mais vagas para carros!");
            }
        }
    ...
    public boolean saiVeiculo(String placa) {
        ...
        System.out.printf("Nao ha veiculo estacionado com a placa: %s.\n", placa);
        return false;
    }
    ...
    public void mostrarVeiculosEstacionados() {
        ...
        if (carros.size() == 0) System.out.println("Nao ha carrro estacionado!");

        System.out.println("\nMotos estacionadas:\n ");
        for (Moto moto : motos) {
            System.out.printf("Placa: %s\n", moto.getPlaca());
        };
        if (motos.size() == 0) System.out.println("Nao ha moto estacionada!");
    }
}
